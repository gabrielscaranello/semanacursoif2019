    ...
    <div class="footer_bottom_area">
        <div class="container">
            <div class="row ">
                <div class="col-12 col-md-3">
                    <div class="footer_bottom">
                        ...
                        <div>
                            <p class="footer-paragraph text-justify">
                                A Semana de cursos do Eixo de Informação e Comunicação do IFPR - Campus Assis Chateaubriand, está sendo organizada pelos alunos do curso de TADS. Com muita vontade de fazer o melhor, continuamos trabalhando para ter um
                                SUPER evento!
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6">
                    <div class="footer_bottom">
                        <h6 class="footer-title">Conheça o time da Semana de Cursos</h6>
                        <div class="row">
                            <div class="col-6">
                                <div class="text-left">
                            ...
                            <div class="col-6">
                                <div class="text-left">
                                    <p class="teams"><i class="fa fa-angle-right" aria-hidden="true"></i><a href="/equipes/#inscricoes"> Equipe de Inscrições</a></p>
                                    <p class="teams"><i class="fa fa-angle-right" aria-hidden="true"></i><a href="/equipes/#minicursos"> Equipe de Minicursos</a></p>
            ...
            <div class="col-12 p-0 m-0">
                <div class="footer_bottom">
                    <p>Desenvolvido por <a href="https://www.facebook.com/gabrieljscaranello" target="_blank">Gabriel Scaranello</a> e <a target="_blank" href="https://www.facebook.com/emanuelhschulz">Emanuel Schulz</a></p>
                </div>
            </div>
