...
<div class="container-fluid">
    <div class="row">
        <div class="col-12 px-1" v-if="cronograma == 'TADS'">
        ...
        @if ($cronogramIIN)
        <div class="col-12 px-1" v-if="cronograma == 'IIN'">
            @foreach ($cronogramIIN as $element)
            <div class="col-12 mb-3 day">
                <div class="row text-light bg-dark py-2 font-weight-bold">
                    <div class="col-12 col-md-6 text-left">
                        {{$element[0]->dia_mes}} - {{$element[0]->dia_semana}}
                    </div>
                    <div class="col-12 col-md-6 text-right d-none d-md-block">Cronograma IIN</div>
                </div>
                @foreach ($element as $value)
                @if ($value->type != 'mini-curso')
                <div class="row hour">
        ...
        @else
          <div class="col-12" v-if="cronograma == 'IIN'">
            <p class="text-center text-dark">
              <b>Cronograma ainda não disponível.</b>
            </p>
          </div>
        @endif
    </div>
